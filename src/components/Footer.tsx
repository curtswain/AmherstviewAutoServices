...
>
  Privacy Policy
        ...
        <div className="border-t border-gray-600 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Amherstview Auto. All rights reserved. Website Design by <a href="https://trueedgeautomation.ca" target="_blank" rel="noopener noreferrer"><span className="font-bold">TrueEdge Automation Solutions</span></a></p>
        </div>
      </div>
    </footer>
  );
