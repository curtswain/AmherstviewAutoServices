          ...
          <div className="flex justify-center items-center gap-8 max-w-4xl mx-auto flex-wrap">
            ...
            >
              <img
                ...
                style={{ objectPosition: '0% 50%', width: '140px', objectFit: 'cover' }}
              />
            </a>
            <a
            ...
            >
              <img
                ...
                alt="Monroe"
                className="h-16 w-auto object-contain"
                style={{ objectPosition: '25% 50%', width: '140px', objectFit: 'cover' }}
              />
            </a>
            <a
            ...
            >
              <img
                ...
                alt="Walker"
                className="h-16 w-auto object-contain"
                style={{ objectPosition: '50% 50%', width: '140px', objectFit: 'cover' }}
              />
            </a>
            <a
            ...
            >
              <img
                ...
                alt="ACDelco"
                className="h-16 w-auto object-contain"
                style={{ objectPosition: '100% 50%', width: '140px', objectFit: 'cover' }}
              />
            </a>
          </div>
        </div>
